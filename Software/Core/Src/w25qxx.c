...
/// @brief Функция проверки связи с внешней памятью
/// @return 1 - связь есть, 0 - нет связи
int CheckW25qxxConnection()
{
	uint32_t w25qxxId = W25qxx_ReadID();
	switch(w25qxxId & 0x0000FFFF)
	{
		case 0x4016:	//	w25x32
			return 1;
		break;
